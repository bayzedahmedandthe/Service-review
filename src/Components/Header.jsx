            ...
            <div className="carousel">
                <div id="item1" className="text-white carousel-item lg:flex-row md:flex-row flex-col  p-6 w-full bg-gradient-to-b from-[#00032e] to-slate-600">
                    <div className=" flex justify-cenetr">
                        <div className="lg:pt-60 md:pt-8 lg:mx-16">
                            <h2 className="lg:text-3xl font-semibold">Discover Excellence with Every <span className="text-[#30eaff]">Service Review</span></h2>
                ...
                <div id="item2" className="text-white carousel-item lg:flex-row  md:flex-row flex-col lg:p-0 md:p-0 p-6 w-full  bg-gradient-to-b from-[#00032e] to-slate-600">
                    <div className="lg:pt-60 md:pt-8 lg:mx-12">
                        <h2 className="lg:text-3xl font-semibold ">Trusted Reviews, Empowering Your <span className="text-[#30eaff]">Choices</span></h2>
                ...
                <div id="item3" className=" text-white carousel-item lg:flex-row md:flex-row flex-col lg:p-0 md:p-0 p-6 w-full  bg-gradient-to-b from-[#00032e] to-slate-600">
                    <div className="lg:pt-60 md:pt-8 lg:mx-12">
                        <h2 className="lg:text-3xl font-semibold">Your Opinion Matters—Leave a Review <span className="text-[#30eaff]">Today!</span></h2>
